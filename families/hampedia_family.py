...
class Family(family.Family):          # REQUIRED
    def __init__(self):               # REQUIRED
        ...
        self.name = 'hampedia'        # REQUIRED; replace with actual name

        self.langs = {                # REQUIRED
            'en': 'www.hampedia.org',  # Include one line for each wiki in family
        }
        ...
        self.namespaces[4]['en'] = u'Hampedia'
        self.namespaces[5]['en'] = u'Hampedia talk'
	self.namespaces[-2]['en'] = u'Download'
